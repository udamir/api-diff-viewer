...
import type { ChangeSummary, DiffData, NavigationAPI, NavigationOptions } from "../types";
...
export class NavigationAPIImpl implements NavigationAPI {
	...
	constructor(beforeView: EditorView | null, afterView: EditorView | null, diffData: DiffData) {
