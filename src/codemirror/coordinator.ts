...
import { setDiffDataEffect, setExpandedBlocksEffect, toggleBlockExpandedEffect } from "./state/diff-state";
import type { DiffCoordinator, DiffData, NavigationAPI, NavigationOptions } from "./types";
...
export function createCoordinator(beforeView: EditorView, afterView: EditorView, diffData: DiffData): DiffCoordinator {
