...
import type { CoordinatorOptions, DiffConfig, DiffData, DiffPairResult } from "./types";
...
export function diff(data: DiffData, config?: Partial<DiffConfig>): Extension {
	...
	const extensions: Extension[] = [diffStateField, diffDecorationsTheme];
...
export function createDiffPair(
	...
	beforeView.dispatch({
		effects: [setSideEffect.of("before"), setDiffDataEffect.of(diffData)],
	});
	...
	afterView.dispatch({
		effects: [setSideEffect.of("after"), setDiffDataEffect.of(diffData)],
	});
...
export function createUnifiedDiff(
	...
	view.dispatch({
		effects: [setSideEffect.of("unified"), setDiffDataEffect.of(diffData)],
	});
