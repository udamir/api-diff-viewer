export default {
  ...
  channels: {
    "/v1/marketdata/{symbol}": {
      parameters: {
        symbol: {
          description: "All symbols are formatted as CCY1CCY2 where prices are in CCY2 and quantities are in CCY1. To read more click [here](https://docs.sandbox.gemini.com/websocket-api/#symbols-and-minimums).\n",
          schema: {
            type: "string",
            enum: [
              "btcusd",
    ...
    schemas: {
      ...
      default: {
        ...
        properties: {
          socket_sequence: {
            type: "integer",
            description: "zero-indexed monotonic increasing sequence number attached to each message sent - if there is a gap in this sequence, you have missed a message. See [Sequence Numbers](https://docs.sandbox.gemini.com/websocket-api/#sequence-numbers) for more information."
          }
        }
      },
      events: {
